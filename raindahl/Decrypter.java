				...
				for(int rs = 0; rs< 16; rs++){
					for(int cs = 0; cs< 16; cs++){
						if(cipherText[r][c].equals(codeMatrix[rs][cs])){
							...
							if(rs == 10)cipherText[r][c] = "a";
							else if(rs == 11)cipherText[r][c] = "b";
							else if(rs == 12)cipherText[r][c] = "c";
							else if(rs == 13)cipherText[r][c] = "d";
							else if(rs == 14)cipherText[r][c] = "e";
							else if(rs == 15)cipherText[r][c] = "f";
							else cipherText[r][c] = Integer.toString(rs);
							
							
							if(cs == 10)cipherText[r][c] += "a";
							else if(cs == 11)cipherText[r][c] += "b";
							else if(cs == 12)cipherText[r][c] += "c";
							else if(cs == 13)cipherText[r][c] += "d";
							else if(cs == 14)cipherText[r][c] += "e";
							else if(cs == 15)cipherText[r][c] += "f";
							else cipherText[r][c] += Integer.toString(cs);
						}
					}
				}
			}
